const Text = {
  ...
  german: {
    ...
    education: {
      ...
      text: 'Bachelor of Applied Science - BASc, Informationssysteme',
      skills: 'Fähigkeiten',
      skillsText: 'Python · Java · C++ · MySQL',
      words: 'Wörter',
      characters: 'Zeichen',
  ...
  portuguese: {
    ...
    education: {
      ...
      subtitle: 'Grau Universitário',
      dates: 'Julho de 2018 - Julho de 2023',
      text: 'Bacharel em Ciências Aplicadas - BASc, Sistemas de Informação',
      skills: 'Habilidades',
      skillsText: 'Python · Java · C++ · MySQL',
      words: 'Palavras',
